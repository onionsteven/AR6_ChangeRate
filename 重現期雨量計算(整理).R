...
length(return_rain_6_9_term3) #3 
sapply(return_rain_6_9_term3,length)
unname(sapply(return_rain_6_9_term3[[3]][[4]],dim))
names(return_rain_6_9_term3[[3]][[4]])

names(return_rain_6_9_term3)
names(return_rain_6_9_term3[[3]])
